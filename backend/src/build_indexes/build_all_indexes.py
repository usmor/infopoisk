...
print(f"Время построения и сохранения индекса BM25: {round(time.time() - start_time, 4)} сек")
...
print(f"Время построения и сохранения индекса Word2Vec: {round(time.time() - start_time, 4)} сек")
...
print(f"Время построения и сохранения индекса Fasttext: {round(time.time() - start_time, 4)} сек")